...
def get_preimg(name_list,results):
    path_folder = "path" #저장할 이미지 파일 경로 입력(수정하기)
...
name_list,price_list,link_list = find_item('라면') #검색어 수정하기
links=get_img(link_list)
...
dir_path = "/Users/leechanho8511/PycharmProjects/Sogong/imgsfile/"
empy_file(dir_path)
...
re=naver_clova(img_path)


# In[40]:


stts=find_allergy(name_list,re)
print(stts)
